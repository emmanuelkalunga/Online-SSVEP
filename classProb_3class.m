...
%             eps = 0.01;
            ...
            for typ = 1:numel(types)
                ...
                class(typ,:) = (typ-1)*ones(size(pos(typ,:))); %--!!! THIS MIGHT CAUSE A PROBLEM (typ-1 or typ) *****
            end
...
save('classProb_3class.mat', 'classProb', 'Labels', 'resMatrix', 'resMean', 'del_sub_all', 'subNbrOfSess');
