...
%             eps = 0.01;
            ...
            labels = CLASS';
            ac(sub-5, testSession) = sum((labels-Ytest)==0)/(trialPerSession*3- numel(find(Ytest==-1)));
...
disp('---------------------------------------------------');
save('online_curve_potato_3class.mat', 'itr', 'tLen2', 'resMatrix', 'resMean', 'ac', 'del_sub_all', 'subAcMean', 'delay_fin_all');
% conf = 0.7
